...
export function TechRadar({ entries, className = "" }: TechRadarProps) {
  ...
  return (
    <div className={`relative ${className}`}>
      ...
      {tooltipData && (
        <div
          className="absolute pointer-events-none bg-zinc-900 border border-zinc-700 rounded-lg px-3 py-2 shadow-xl z-50"
        ...
        >
          ...
          {tooltipData.version && (
            <div className="text-xs text-zinc-400">v{tooltipData.version}</div>
          )}
      ...
      {/* Category Legend */}
      <div className="absolute bottom-4 left-4 bg-zinc-900/90 backdrop-blur-sm border border-zinc-800 rounded-lg p-3 flex flex-wrap gap-3">
